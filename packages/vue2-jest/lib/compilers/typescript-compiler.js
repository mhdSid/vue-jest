...
module.exports = function compileTypescript(
  scriptContent,
  vueJestConfig,
  filePath
) {
  ...
  const inputSourceMap =
    res.sourceMapText !== undefined ? JSON.parse(res.sourceMapText) : false // inputSourceMap must be a boolean, object, or undefined as per babel requirements
  ...
  if (
    ...
    !loadBabelConfig(vueJestConfig, filePath)
  ) {
    inlineBabelConfig = {
